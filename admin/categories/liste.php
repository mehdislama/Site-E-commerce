    ...
    <div class="container-fluid">
      ...
      ?>
       ...
       if(isset($_GET['ajout']) && $_GET['ajout']== 'ok'){
         ...
         Categorie ajouter avec SUCCEES !
    </div>';
       }
       ?>
...
<?php
       if(isset($_GET['delete']) && $_GET['delete']== 'ok'){
         print'<div class="alert alert-success">
         Categorie supprimer avec SUCCEES !
    </div>';
       }
       ?>
...
<?php
       if(isset($_GET['modification']) && $_GET['modification']== 'ok'){
         print'<div class="alert alert-success">
         Categorie modifiee avec SUCCEES !
    </div>';
       }
       ?>
        ...
        foreach($categories as $categorie){
           ...
           print' <tr>
            ...
            <td>
                  ...
                  <a data-toggle="modal" data-target="#editModel'.$categorie['id'].'" class = "btn btn-success">Modififer</a>
                  <a onclick="return popUpDeleteCategorie()" href="supprimer.php?id-cat='.$categorie['id'].'"class = "btn btn-danger">Supprimer</a>
